...
function writeAddUserCookies() {
   ...
   document.cookie = church_affiliation.name + "=" + escape(church_affiliation.values) + ";";
   ...
   document.cookie = comm_email.name + "=" + escape(comm_email.value) + ";";
   document.cookie = comm_sms.name + "=" + escape(comm_sms.value) + ";";
   document.cookie = comm_phone.name + "=" + escape(comm_phone.value) + ";";
