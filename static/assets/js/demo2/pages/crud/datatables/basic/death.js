...
$("#member_id").on("keyup", function(e) {
    ...
    if ($(this).val().length >= 3) {
        ...
        $.ajax({
            ...
            url: "/load_user_by_id/member_id_check",
														...
														<div class="kt-invoice__body kt-invoice__body--centered">
															...
															<div class="row">
																...
																<div class="col">
																	...
																	<label>` + data.date_of_birth + `</label>
																</div>
															</div>
															<br/>
															<div class="row">
																<div class="col">
																	...
																	<label>` + data.aged + `</label>
																</div>
																<div class="col">
																	<strong>Date of Death:</strong><br/>
																	<label>` + data.death_date + `</label>
																</div>
																<div class="col">
																<strong>Burial Date:</strong><br/>
																<label>` + data.burial_date + `</label>
																</div>
															</div>
															<br/>
															<div class="row">
																<div class="col">
																	<strong>Place of Burial:</strong><br/>
																	<label>` + data.place_of_burial + `</label>
																</div>
																<div class="col">
